...
glyco_file <- "glycopeptide_order_for_stats.csv"
...
write.csv(glyco_data_with_motif, "driedblood_glyco_data_with_motif_exported_stats.csv", row.names = FALSE)
...
#export data
write.csv(glyco_data_for_MOFA, "driedblood_glyco_stats.csv", row.names = FALSE)
