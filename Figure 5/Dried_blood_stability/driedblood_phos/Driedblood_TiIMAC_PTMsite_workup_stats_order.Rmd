...
nonlocalized_data <- "20250513_074537_Dryblood_phospho_stability_SN19_25_3_PTM_Report_noloc.tsv"
nonlocalized_data <- read_tsv(nonlocalized_data)

# Importing the second TSV file
localized_data <- "20250513_074537_Dryblood_phospho_stability_SN19_25_3_PTM_Report_loc.tsv"
...
write.table(filtered_data_nonredundant, "Driedblood_PTMsite_sum.tsv", sep = "\t", row.names = FALSE, quote = FALSE)
...
write.table(filtered_data_subset, "Driedblood_PTMsite_sum_stats_order.csv", sep = ",", row.names = FALSE, quote = FALSE)
```
