...
glyco_file <- "glycopeptide_order_for_MOFA.csv"
...
write.csv(glyco_data_with_motif, "glyco_data_with_motif_exported_MOFA.csv", row.names = FALSE)
...
#export data
write.csv(glyco_data_for_MOFA, "driedblood_glyco_MOFA.csv", row.names = FALSE)
