...
phos <- read.csv("wetblood_phospho_TiO_MOFA.csv", header = TRUE, check.names = FALSE)
...
plot_with_legend <- plot_factors(mofa, factors = 1:2, color_by = "group", dot_size = 6, alpha = 0.6) +
  coord_fixed(ratio = 1) +
  theme(
...
# Save the plot as a PNG file
ggsave("Wetblood_TiO_top_50_weights_phospho_PTM_factor1.png", plot = phospho_plot, width = 16, height = 14, dpi = 600)
