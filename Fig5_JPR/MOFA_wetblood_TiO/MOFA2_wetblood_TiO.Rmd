...
# Write to CSV
write.csv(top_weights_df, file = "top_20_weights_phospho_PTM_factor1.csv", row.names = FALSE)


# Load the dataset
phospho_data <- read.csv("top_20_weights_phospho_PTM_factor1.csv")  # Update with your actual file path
...
# Save the plot as a PNG file
ggsave("Wetblood_TiO_top_20_weights_phospho_PTM_factor1.png", plot = phospho_plot, width = 16, height = 14, dpi = 600)
